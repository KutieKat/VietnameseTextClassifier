      ...
      <div className="wrapper details">
        ...
        <ul>
          <li>
            ...
            công sức. <strong>VietnameseTextClassifier API</strong> là giải pháp
            giúp phân loại văn bản tiếng Việt một cách nhanh chóng và hiệu quả.
          </li>
          <li>
            <strong>VietnameseTextClassifier API</strong> hỗ trợ phân loại văn
        ...
        <p>
          <strong>VietnameseTextClassifier API</strong> có chức năng trả về tên
          chủ đề{' '}
          <i>
