                                    ...
                                    <td>
                                        <div className='table-menu'>
                                            ...
                                            <ul className='table-menu__list'>
                                                <li className='table-menu__list-item'><Link to='/bang-dieu-khien/request/1'>Xem thông tin</Link></li>
                                            </ul>
                                        </div>
                                    </td>
                                    <td>nguyenvana</td>
                                ...
                                <tr>
                                    <td>
                                        <div className='table-menu'>
                                            ...
                                            <ul className='table-menu__list'>
                                                <li className='table-menu__list-item'><Link to='/bang-dieu-khien/request/2'>Xem thông tin</Link></li>
                                            </ul>
                                        </div>
                                    </td>
                                    <td>tranvanb</td>
