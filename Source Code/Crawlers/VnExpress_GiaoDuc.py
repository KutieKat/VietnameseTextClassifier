...
class VnExpressGiaoDucSpider(scrapy.Spider):
    name = 'VnExpressGiaoDucCrawler'
    file_id = 1
    ...
    def start_requests(self):
        ...
        for i in range(1, MAX_PAGES):
            url = 'https://vnexpress.net/giao-duc-p' + str(i)
            urls.append(url)
    ...
    def parse_details(self, response):
        ...
        if (len(content) > 10):
            file_name = 'VnExpress/GiaoDuc/' + str(self.file_id) + '.txt'
